...
namespace DocumentManager.Core.Converters.Handlers
{
    public class DocxStamp
    {
        ...
        [Obsolete("Use \"GenerateParagraph\" instead.")]
        private Paragraph GenerateParagraphV0()
        {
            Paragraph paragraph1 = new Paragraph();
            ...
            V.Stroke stroke2 = new V.Stroke()
            {
                Weight = "36720",
                Color = "#004586",
                JoinStyle = V.StrokeJoinStyleValues.Round,
                EndCap = V.StrokeEndCapValues.Flat,
                DashStyle = "longdash"
            };
            Wvml.TextWrap textWrap1 = new Wvml.TextWrap() { Type = Wvml.WrapValues.None };
