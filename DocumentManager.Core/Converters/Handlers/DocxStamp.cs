...
namespace DocumentManager.Core.Converters.Handlers
{
    public class DocxStamp
    {
        ...
        public MemoryStream Create(string filePath)
        {
            var docxMs = Extensions.GetFileAsMemoryStream(filePath);

            using (WordprocessingDocument document = WordprocessingDocument.Open(docxMs, true))
            {
                ImagePart imagePart1 = document.MainDocumentPart.AddNewPart<ImagePart>("image/png", "rId200");
                GenerateImagePart1Content(imagePart1);

                var p = GenerateParagraph2();
        ...
        private Paragraph GenerateParagraph()
        {
            ...
            SpacingBetweenLines spacingBetweenLines1 = new SpacingBetweenLines()
                {Before = "0", After = "160", Line = "259", LineRule = LineSpacingRuleValues.Auto};
            ...
            positionOffset2.Text = "1861185";

            verticalPosition1.Append(positionOffset2);
            Wp.Extent extent1 = new Wp.Extent() {Cx = 1271905L, Cy = 445770L};
            ...
            A.Transform2D transform2D1 = new A.Transform2D() {Rotation = 20512800};
            A.Offset offset1 = new A.Offset() {X = 0L, Y = 0L};
            A.Extents extents1 = new A.Extents() {Cx = 1271160L, Cy = 444960L};
            ...
            A.Outline outline1 = new A.Outline() {Width = 36720};

            A.SolidFill solidFill1 = new A.SolidFill();
            A.RgbColorModelHex rgbColorModelHex1 = new A.RgbColorModelHex() {Val = "004586"};

            solidFill1.Append(rgbColorModelHex1);

            A.CustomDash customDash1 = new A.CustomDash();
            A.DashStop dashStop1 = new A.DashStop() {DashLength = 50000, SpaceLength = 50000};
            A.DashStop dashStop2 = new A.DashStop() {DashLength = 50000, SpaceLength = 50000};
            ...
            paragraphProperties2.Append(kinsoku1);
            paragraphProperties2.Append(overflowPunctuation1);
            paragraphProperties2.Append(autoSpaceDE1);
            ...
            {
                Ascii = "Courier New", HighAnsi = "Courier New", EastAsia = "Calibri", ComplexScript = "",
                EastAsiaTheme = ThemeFontValues.MinorHighAnsi, ComplexScriptTheme = ThemeFontValues.MinorBidi
            };
            ...
            {
                Wrap = A.TextWrappingValues.Square, LeftInset = 17640, TopInset = 17640, RightInset = 17640,
                BottomInset = 17640, Anchor = A.TextAnchoringTypeValues.Center
            };
            ...
            {
                Id = "_x0000_t202", CoordinateSize = "21600,21600", OptionalNumber = 202,
                EdgePath = "m,l,21600l21600,21600l21600,xe"
            };
            ...
            V.Shape shape1 = new V.Shape()
            {
                Id = "shape_0",
                Style =
                    "position:absolute;margin-left:357.95pt;margin-top:146.5pt;width:100.05pt;height:35pt;mso-wrap-style:square;v-text-anchor:middle;rotation:342",
                Stroked = true, Type = "shapetype_202"
            };
            shape1.SetAttribute(new OpenXmlAttribute("", "ID", "", "Shape1"));
            ...
            Kinsoku kinsoku2 = new Kinsoku() {Val = true};
            OverflowPunctuation overflowPunctuation2 = new OverflowPunctuation() {Val = false};
            AutoSpaceDE autoSpaceDE2 = new AutoSpaceDE() {Val = true};
            ...
            paragraphProperties3.Append(kinsoku2);
            paragraphProperties3.Append(overflowPunctuation2);
            paragraphProperties3.Append(autoSpaceDE2);
            ...
            {
                Weight = "36720", Color = "#004586", JoinStyle = V.StrokeJoinStyleValues.Round,
                EndCap = V.StrokeEndCapValues.Flat, DashStyle = "longdash"
            };
        ...
        // Creates an Paragraph instance and adds its children.
        private Paragraph GenerateParagraph2()
        {
            Paragraph paragraph1 = new Paragraph();
